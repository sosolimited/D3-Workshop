...
var clientData = (function() {
	...
	var checkGeoEvents = function() {
		...
		// Example: Object {team: "seahawks", username: "PeaceoutR", name: "Rachel Schovajsa", location: Array[2], time: "Tue Dec 23 20:39:12 +0000 2014"}
	...
	var displayGraphs = function() {
			...
			if ( isFirstDataLoad ) {
			  ...
			  clientPageController.setTeam( "team-b", "patriots-game" );
		  } else {
